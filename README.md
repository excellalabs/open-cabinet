...
##Concept
OpenCabinet is a tool for the public to find interactions (ie Warfarin and Ibuprofen) between the medicine that they and their family are taking using data directly from the FDA.
